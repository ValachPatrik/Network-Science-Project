...
def clean_articles_authors():
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"Loaded {len(all_articles)} articles with authors/locations/departments"
            )
            ...
            for article in all_articles:
                        ...
                        if isinstance(author_list, list):
                            ...
                            if updated:
                                ...
                                article.authors = json.dumps(
                                    cleaned_list, ensure_ascii=False
                                )
                ...
                if articles_updated > 0 and articles_updated % 500 == 0:
                    try:
                        ...
                        logger.info(
                            f"Processed {articles_updated} articles... (authors: {author_names_cleaned}, locations: {location_names_cleaned}, depts: {department_names_cleaned})"
                        )
